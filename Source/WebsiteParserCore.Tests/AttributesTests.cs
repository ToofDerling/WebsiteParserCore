...
using WebsiteParserCore.Tests.Properties;
...
namespace WebsiteParserCore.Tests
{
    ...
    public class AttributesTests
    {
        ...
        public void ReplaceAttributeTextTest()
        {
            ...
            var input = docNode.QuerySelector(".band_comment").InnerText;
        ...
        public void ReplaceAttributeRegexTest()
        {
            ...
            var docNode = document.DocumentNode;
            string input = docNode.QuerySelector(".band_comment").InnerText;
